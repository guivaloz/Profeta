...
class EquiposDnsmasqconf(Equipos):
    ...
    def crear(self):
        ...
        if self.vlan != '':
            ...
            a.append("listen-address={0}".format(self.obtener_profeta_ip_address()))
            a.append("")
        ...
        if self.vlan != '':
            ...
            a.append("")
            a.append("# Set the NTP time server addresses")
            a.append("dhcp-option=option:ntp-server,{0}".format(self.obtener_profeta_ip_address()))
            a.append("")
